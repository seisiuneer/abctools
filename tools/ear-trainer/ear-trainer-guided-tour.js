...
function steps(){return[
 ...
 {title:"1. Choose an Answer Style",selector:"#answerStyle",body:"<p>Choose what you want to identify by ear: rhythm, key, mode, or a combination of them.</p>"},
 ...
 {title:"3. Number of Questions",selector:"#questionCount",body:"<p>Choose 10 questions (the default), 25 questions, or Unlimited. Your choice is saved in this browser.</p>"},
 {title:"4. Choose Auto-play on Next Tune",selector:"#autoPlayNext",body:"<p>This setting is disabled by default. When enabled, clicking Next Tune automatically starts playback after the next tune is loaded. Playback loops automatically. Your choice is saved in this browser when possible.</p>"},
 {title:"5. Listen to the Tune",selector:"#tuneAudioControls",body:"<p>Use this playback bar to listen to the current tune. Tunes loop automatically. The answer choices become available after you start playback.</p>"},
 {title:"6. Choose Your Answer",selector:"#answerChoiceLayout",body:"<p>Select your answer for each question shown here. The questions depend on the Answer Style you selected.</p>"},
 {title:"7. Submit and Review",selector:"#submitBtn",body:"<p>Click <strong>Submit Answer</strong> to check your response. The trainer shows the correct answer and identifies the tune. For key and/or mode exercises, you can also listen to root notes and scales to reinforce or compare your answers.</p>"},
 {title:"8. Follow Your Progress",selector:".progressCard",body:"<p>For 10- and 25-question sessions, Session Progress shows how many tunes you have answered and your current accuracy. In Unlimited mode, the progress bar is hidden and Session Progress shows running Correct and Incorrect totals.</p>"},
 {title:"9. Move Through the Session",selector:"#nextBtn",body:"<p>For 10- and 25-question sessions, use <strong>Next Tune</strong> and <strong>Previous Tune</strong> to move through the session. After the final tune, <strong>Show Final Review</strong> displays your session results and lets you practice any tunes you missed. In Unlimited mode, <strong>Next Tune</strong> continues with another random tune and there is no Final Review.</p>"},
