...
// website_to_abc.js
//
// ABC Tools Website to ABC Extraction Tool
//
//
...
function saveOutput() {
    ...
    if (gSaveFilename == "") {
        gSaveFilename = "website_to_abc.abc";
    }
...
function testOutput() {
    ...
    var shareName = "Website_to_ABC_Test";
...
function DoStartup() {
    ...
    var fileElement = document.getElementById('selecthtmlfile');
    ...
    if (gIsIOS) {
        document.getElementById("selecthtmlfile").removeAttribute("accept");
    }
    ...
    document.getElementById('selecthtmlfile').addEventListener('change', async (event) => {
        ...
        if (file) {
            ...
            gSaveFilename = gSaveFilename.replace(".html","");
            gSaveFilename = gSaveFilename.replace(".HTML","");
            gSaveFilename += ".abc";
            ...
            reader.onload = async function() {
                ...
                // Reset file selectors
                let fileElement = document.getElementById('selecthtmlfile');
