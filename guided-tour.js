...
(function () {
  ...
  function getAdditionalGuidedTourSteps(tourId) {
    ...
    if (tourId === "trainer") return [
      ...
      { title:"Configure Tune Trainer Speed Settings", cardTargetGap:150, cardWidth:620, target:function(){return document.getElementById("looper_start_percent");}, body:'<p>The tour will set the starting tempo to <strong>50%</strong>, ending tempo to <strong>100%</strong>, tempo increment to <strong>10%</strong>, increment after <strong>1</strong> time through the tune, and disable the countdown.</p><p>It will also turn off <strong>Add two-measure click intro?</strong> and <strong>Add trailing rests?</strong> before the settings are applied.</p>', afterNext:function(){ setControlValue("looper_start_percent","50","input"); setControlValue("looper_end_percent","100","input"); setControlValue("looper_increment","10","input"); setControlValue("looper_count","1","input"); setControlValue("looper_docountdown",false); setControlValue("looper_clickintro",false); setControlValue("looper_addmeasure",false); return waitMs(300); } },
